...
#else /* SSO */
    SSL_CVERIFY_OPTIONAL_NO_CA  = 3,
    SSL_CVERIFY_EBANKING        = 4,
    SSL_CVERIFY_ELECTRA         = 5,
    SSL_CVERIFY_UPLOAD          = 6,
    SSL_CVERIFY_DOWNLOAD        = 7,
    SSL_CVERIFY_UPLOAD_AUTH     = 8,
    SSL_CVERIFY_DOWNLOAD_AUTH   = 9,
    SSL_CVERIFY_WEBSERVICE      = 10,
    SSL_CVERIFY_PKIOPERATOR     = 11,
    SSL_CVERIFY_SECOFF          = 12,
    SSL_CVERIFY_FORBIDDEN       = 13,
    SSL_CVERIFY_LOGOFF          = 14,
    SSL_CVERIFY_IDENTIFIED      = 15,
    SSL_CVERIFY_PDG             = 16,
    SSL_CVERIFY_PDGPOST         = 17,
    SSL_CVERIFY_CIS             = 18,
    SSL_CVERIFY_ACTUATE         = 19,
    SSL_CVERIFY_NOQUERY         = 20,
    SSL_CVERIFY_EID             = 21,
    SSL_CVERIFY_OTU             = 22,
    SSL_CVERIFY_MOBILE_ACT      = 23,    // SECU-2209 Mobile activation mode
    SSL_CVERIFY_MOBILE_LOG      = 24,    // SECU-2209 Mobile logon mode
    SSL_CVERIFY_LOGIN           = 25,    // SECU-2671 Bisc logon mode
    SSL_CVERIFY_AUTH            = 26     // SECU-2671 Bisc logon mode
#endif /* SSO */
} ssl_verify_t;
...
#ifdef SSO
    sso_ctx         sso;
   /* ISABEL specific directive for enabling TLS workaround */
    BOOL           force_empty_fragment;
#endif
};
...
#ifdef SSO
/*ISABEL specific directive */
const char *ssl_cmd_SSLIsaForceEmptyFragment(cmd_parms *cmd, void *dcfg, int flag);
#endif
